    ...
    pub fn validate(input: &[u8], structural_indexes: &[u32]) -> Result<(Vec<(CharType, u32)>)> {
            ...
            () => {{
                ...
                match c {
                    b',' => {
                        ...
                        update_char!();
                        if c == b'"' {
                            insert_res!(CharType::String, idx);
                            goto!(ObjectKey);
                        } else {
        ...
        match c {
            b'{' => {
                ...
                last_start = r_i;
                insert_res!(CharType::Object, idx);
