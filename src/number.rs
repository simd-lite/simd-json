// Taken from json-rust
// https://github.com/maciejhirsz/json-rust/blob/677a590e5f8680e3251ab3a8fe07fe144fa4c4f9/src/number.rs
...
impl Number {
    ...
    pub fn as_f64(&self) -> Option<f64> {
        match self.category {
            NEGATIVE => Some(-exponentiate_f64(self.mantissa as f64, self.exponent)),
            POSITIVE => Some(exponentiate_f64(self.mantissa as f64, self.exponent)),
            _ => None,
        }
    }
